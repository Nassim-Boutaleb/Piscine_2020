...
<script>
 ...
 <!-- Alertes -->
        ...
        <blockquote class="blockquote text-center">
                <p class="mb-0">BON POUR LE MUSEE</p>
        ...
        if ($db_found) 
        {
            ...
            $sql="SELECT * FROM item WHERE Categorie='Bon pour Muse' AND afficher='1'";          $result = mysqli_query($db_handle, $sql);
        ...
        <p class="card-text"><small class="text-muted">Description : <?php echo $data["Description"];?></small></p>
            ...
            <?php
                ...
                if ($statut == "acheteur")
                {
                    ...
                    {
                        ?><button type="submit" id="BtnMO<?php echo($data["NumeroID"]); ?>" name="negocier" value="<?php echo($data["NumeroID"]); ?>" class="btn btn-secondary " data-toggle="modal" data-target="#offreID<?php echo($data["NumeroID"]); ?>">Negocier</a></button>
