<!-- Ce script est intégré par require dans modal_encheres_traitements.php et n'est pas indéêndant ! -->
<?php
    ...
    if ($_POST["useCarte"] != "nouvCarte" )  // carte existante
    {
        ...
        { 
            ...
            if($montantOffreinput>=$creditCarte)  // c'est trop cher : la transaction est refusée !
            {
                $errorPaiement = 2;
                echo ("Offre refusée: solde insuffisant");
                ?><meta http-equiv="refresh" content="1; url=catalogue_meilleuroffre.php?alertCode=80"><?php
            }
    ...
    else 
    {
        ...
        { 
            ...
            if(!$result)
            {
                ...
                ?><meta http-equiv="refresh" content="9; url=catalogue_meilleuroffre.php?alertCode=82"><?php 
            }
            else
            {
